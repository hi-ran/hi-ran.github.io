...
const subImgClick = (e, index, m = false) => {
    ...
    if (m) {
        //$('.wi' + e + ' .IMG_main').html(`<img class='mobileImg' src='/img/project1/${e}_${index}.png' alt='프로젝트 이미지' onclick="mainImgClick(${e}, ${index}, ${m})">`);
        document.querySelector('.wi' + e + ' .IMG_main').outerHTML = `<div class="IMG_main" onclick="mainImgClick(${e}, ${index}, ${m})"><img class='mobileImg' src='/img/project1/${e}_${index}.png' alt='프로젝트 이미지'></div>`;
    } else {
        //$('.wi' + e + ' .IMG_main').html(`<img src='/img/project1/${e}_${index}.png' alt='프로젝트 이미지' onclick="mainImgClick(${e}, ${index}, ${m})">`);
        document.querySelector('.wi' + e + ' .IMG_main').outerHTML = `<div class="IMG_main" onclick="mainImgClick(${e}, ${index}, ${m})"><img src='/img/project1/${e}_${index}.png' alt='프로젝트 이미지'></div>`;
    }
...
const mainImgClick = (e, index, m = false) => {
    ...
    $('.sizeUP').focus();
    if (m) {
        $('.sizeUP .ct').html(`<img class='mobileImg' src='/img/project1/${e}_${index}.png' alt='프로젝트 이미지'>`);
    } else {
        $('.sizeUP .ct').html(`<img src='/img/project1/${e}_${index}.png' alt='프로젝트 이미지'>`);
    }
...
const visualImgClick = (img, m = false) => {
    ...
    $('.sizeUP').focus();
    if (m) {
        $('.sizeUP .ct').html(`<img class='mobileImg' src='/img/project1/${img}' alt='디자인 작업물'>`);
    } else {
        $('.sizeUP .ct').html(`<img class='visualImg' src='/img/project1/${img}' alt='디자인 작업물'>`);
    }
    $('.sizeUP .ct').scrollTop(0);
    $('html').css('overflow', 'hidden');
}
...
const pastImgClick = (img, m = false) => {
    ...
    $('.sizeUP').focus();
    if (m) {
        $('.sizeUP .ct').html(`<img class='mobileImg' src='/img/past/${img}' alt='디자인 작업물'>`);
    } else {
        $('.sizeUP .ct').html(`<img class='pastImg' src='/img/past/${img}' alt='디자인 작업물'>`);
    }
    $('.sizeUP .ct').scrollTop(0);
    $('html').css('overflow', 'hidden');
}
